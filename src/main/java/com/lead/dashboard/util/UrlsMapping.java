...
public class UrlsMapping {
	...
	public static final String CHECK_PENDING_AMOUNT=PREFIX+"/leadEstimate/checkPendingAmount";
	...
	public static final String GET_ALL_TYPE_LEAD=PREFIX+"/salesDashboard/getAllTypeLead";
...
//  Rating Controller
	...
	public static final String MOVE_COMPLIANCE_DOC=PREFIX+"/complianceDocumnets/moveComplianceDoc";
	public static final String GET_COMPLIANCE_DOC_BY_NAME=PREFIX+"/complianceDocumnets/getComplianceDocByName";
	...
	public static final String VENDOR_REPORT = "/leadService/api/v1/vendor/vendor-report";
	public static final String VENDOR_SEARCH = "/leadService/api/v1/vendor/vendor-search";
...
//		public static final String UPDATE_VENDOR_CATEGORY = "/leadService/api/v1/vendor/update-category";
		...
		// = = = = = = = == =  ClientDesignation = = == = = = = = = = == = = = = 
		public static final String CREATE_CLIENT_DESIGNATION = PREFIX+"/clientDesignation/createClientDesignation";
		public static final String GET_ALL_CLIENT_DESIGNATION = PREFIX+"/clientDesignation/getAllClientDesignation";
